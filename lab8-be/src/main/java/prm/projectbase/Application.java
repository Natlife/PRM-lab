...
public class Application {
	...
	public CommandLineRunner databaseInitializer(
			...
			prm.projectbase.repository.PostRepository postRepository) {
		return args -> {
			...
			if (postRepository.count() == 0) {
				postRepository.save(prm.projectbase.entity.Post.builder()
						.userId(1)
						.title("Welcome to PRM Lab 8")
						.body("This is the first sample post loaded from our Spring Boot production backend.")
						.build());
				postRepository.save(prm.projectbase.entity.Post.builder()
						.userId(1)
						.title("Flutter and REST API Integration")
						.body("Integrating REST APIs in Flutter is easy with the http package and FutureBuilder.")
						.build());
				postRepository.save(prm.projectbase.entity.Post.builder()
						.userId(2)
						.title("Aesthetic UI Design")
						.body("Production-ready applications should have modern typography, smooth animations, and curated colors.")
						.build());
				postRepository.save(prm.projectbase.entity.Post.builder()
						.userId(2)
						.title("Spring Boot Security Config")
						.body("We configured SecurityConfig to permit all requests to public endpoints while securing administrative APIs.")
						.build());
			}
		};
	}
