...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  void initState() {
    ...
    final task = taskProvider.tasks.firstWhere((t) => t.id == widget.taskId);
  ...
  void _save() {
    ...
    if (title.isNotEmpty) {
      final taskProvider = context.read<TaskProvider>();
      taskProvider.updateTask(widget.taskId, title);
      final task = taskProvider.tasks.firstWhere((t) => t.id == widget.taskId);
      if (task.completed != _completed) {
        taskProvider.toggleTask(widget.taskId);
      }
    }
